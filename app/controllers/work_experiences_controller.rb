class WorkExperiencesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @work_experience.save
        ...
        format.json { render action: 'show', status: :created, location: @work_experience }
      else
  ...
  private
    ...
    def work_experience_params
      params.require(:work_experience).permit(:from, :to, :ongoing, :position, :employer_name, :description)
    end
end
