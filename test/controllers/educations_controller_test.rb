...
class EducationsControllerTest < ActionController::TestCase
  ...
  test "should create education" do
    assert_difference('Education.count') do
      post :create, education: { description: @education.description, from: @education.from, level: @education.level, ongoing: @education.ongoing, organization_name: @education.organization_name, title: @education.title, to: @education.to }
    end
  ...
  test "should update education" do
    patch :update, id: @education, education: { description: @education.description, from: @education.from, level: @education.level, ongoing: @education.ongoing, organization_name: @education.organization_name, title: @education.title, to: @education.to }
    assert_redirected_to education_path(assigns(:education))
  end
